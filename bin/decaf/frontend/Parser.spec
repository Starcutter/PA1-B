...
CASE   DCOPY DO    COMPLEX  SCOPY   SUPER
PRINTCOMP    DEFAULT  OD    DOSEP
'+'  '-'  '*'  '/'  '%'  '='  '>'  '<'  '.'
','  ';'  '!'  '('  ')'  '['  ']'  '{'  '}'
'@'  '$'  '#'  ':'
...
DoSubStmt       :   Expr ':' Stmt
                    {
                        $$.stmt = new Tree.DoSub($1.expr, $3.stmt, $2.loc);
                    }
                    
DoBranch        :   DOSEP DoSubStmt
                    {
                        $$.stmt = $2.stmt;
                    }
...
DoStmt          :   DO DoSubStmt DoBranchList OD
                    {
                        ...
                        $$.stmt = new Tree.DoGuard($3.slist, $1.loc);
                    }
...
CaseExprList    :   ACaseExpr CaseExprList
                    {
...
DefaultExpr     :   DEFAULT ':' Expr ';'
                    {
                        $$.expr = new Tree.DefaultExpr($3.expr, $2.loc);
                    }
