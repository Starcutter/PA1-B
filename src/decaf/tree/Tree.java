...
public abstract class Tree {
    ...
    /**
     * Case expressions, of type CaseExpr.
     */
    public static final int CASE = LABELLED + 1;
    
    /**
     * A case branch (Syntax: "Constant:Expr"), of type ACaseExpr.
     */
    public static final int ACASEEXPR = CASE + 1;
    
    /**
     * Default branch in case expressions, of type DefaultExpr.
     */
     ...
     */
    public static final int SYNCHRONIZED = DEFAULTEXPR + 1;
    ...
    /**
     * Sub statements of a Do-guard statement, of type DoSub.
     */
    public static final int DOSUB = IF + 1;
    
    /**
     * Do-guard statements, of type DoGuard.
     */
    public static final int DOGUARD = DOSUB + 1;

    /**
     * Expression statements, of type Exec.
     */
    public static final int EXEC = DOGUARD + 1;
    ...
    /**
     * A sub statement in a do-guard statement
     * Syntax: "Expr : Stmt"
     */
    public static class DoSub extends Tree {
    	...
    	public DoSub(Expr boolExpr, Tree statement, Location loc) {
    		super(DOSUB, loc);
    	...
    	public void printTo(IndentPrintWriter pw) {
    		...
    		pw.decIndent();	// end branch
    	}
    }
    
    /**
     * A do-guard statement
     * Syntax: "do E1:S1 ||| E2:S2 ||| ... ||| En:Sn od"
     */
    public static class DoGuard extends Tree {
    	
    	public List<Tree> subs;
    	
    	public DoGuard(List<Tree> subs, Location loc) {
    		super(DOGUARD, loc);
    		this.subs = subs;
    	}
...
public static class ACaseExpr extends Expr {
    	...
    	public ACaseExpr(Expr constant, Expr value, Location loc) {
    		super(ACASEEXPR, loc);
    	...
    	public void printTo(IndentPrintWriter pw) {
    		...
    		pw.decIndent();	// end one case branch
    	}
    }
    ...
    public static class DefaultExpr extends Expr {
    	...
    	public DefaultExpr(Expr value, Location loc) {
    ...
    public static class CaseExpr extends Expr {
    	...
    	public List<Expr> cases;
    	
    	public Expr defaultNode;
    	
    	public CaseExpr(Expr switcher, List<Expr> cases, Expr defaultNode, Location loc) {
    		super(CASE, loc);
    	...
    	public void printTo(IndentPrintWriter pw) {
    		...
    		// default
    		defaultNode.printTo(pw);
    		
    		pw.decIndent();	// end cases and default
    		
    		pw.decIndent();	// end case
    	}
    }
    ...
    public static class DCopy extends Expr {
    	...
    	public DCopy(Expr source, Location loc) {
    		super(DCOPY, loc);
    		this.source = source;
    	}
    ...
    public static class SCopy extends Expr {
    	...
    	public SCopy(Expr source, Location loc) {
    		super(SCOPY, loc);
    		this.source = source;
    	}
    ...
    public static abstract class Visitor {
        ...
        public void visitDoGuard(DoGuard that) {
        	visitTree(that);
        }
